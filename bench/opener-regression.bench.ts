...
const cases: OpenerRegressionCase[] = [
  ...
  },
  {
    ...
    input: { queue: "JLSTZIOJLSTZIOTIJLOSZ", beamWidth: 384, hold: true, maxDepth: 21 },
    iterations: 1,
    minDepth: 20,
    minQueueIndex: 21,
    minAttack: 10,
    minDifficultAttack: 10,
    minTSpinClears: 3,
    minTSpinAttack: 8,
  ...
  {
    name: "tl-3spin-10attack-no-pc",
    input: { queue: "ZTSLOJIZJTILSOLTIZJSO", beamWidth: 512, hold: true, maxDepth: 21, setupPoolMultiplier: 36 },
    iterations: 1,
    minDepth: 20,
    minQueueIndex: 21,
    minAttack: 10,
